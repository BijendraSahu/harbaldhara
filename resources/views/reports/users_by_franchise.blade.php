                    ...
                    <div class="col-sm-12 col-md-12 col-xs-12">
                       ...
                       Users By Franchise
                                ...
                                <section id="user_table" class="table_main_containner">
                                    <form action="{{url('search_user_by_franchise')}}" method="post"
                                                ...
                                                @foreach($users as $user_master)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <p class="bg-success">{{isset($user_master->activated_by)?$user_master->activate_by->name:'-'}}</p>
